...
## Install: RustEmu need boost

x64 boost libraries for VS projects x64 build must be in %BOOST_ROOT%/stage/x64/lib

x86 boost libs placed into %BOOST_ROOT%/stage/lib (default location)
